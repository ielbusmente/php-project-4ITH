<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand hover-tilt" href="index.php"><img class="logo" src="assets/sleepy_text.png" height="80" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbar1">
            <ul class="navbar-nav ml-auto ">
                <li class="nav-item">
                    <a class="nav-link text-dark hover-enlarge" href="https://www.facebook.com/sleepyyyph" target="_blank"> &nbsp;
                        <i class="bi bi-facebook" style="color:#D8C47F;"></i>
                        <!-- <span class="sr-only">(current)</span> -->
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark hover-enlarge" href="https://www.instagram.com/sleepyph_/" target="_blank"> &nbsp;
                        <i class="bi bi-instagram" style="color:#D8C47F;"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark hover-enlarge" href="https://shopee.ph/sleepyph_" target="_blank"> &nbsp;
